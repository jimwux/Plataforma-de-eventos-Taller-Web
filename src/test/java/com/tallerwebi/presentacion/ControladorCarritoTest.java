...
public class ControladorCarritoTest {
    ...
    public void init(){
        ...
        this.controladorCarrito = new ControladorCarrito(servicioCarritoMock);
    }
    ...
    public void alAgregarObtejosAlCarritoSeRetornaALaVistaCorrecta() {
        ...
        ModelAndView modelAndView = controladorCarrito.agregarAlCarrito(idsEntradas, cantidades);
